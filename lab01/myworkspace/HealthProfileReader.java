...
public class HealthProfileReader {
	...
	public static void main(String[] args) {
		...
		//createPerson("A","B",new Date(10));
		//displayHealthProfile(new String("A "+"B"));
	...
	//Since the key is a String for the map database is a String then Long personid will not work
